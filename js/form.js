!(function (d) {
  ...
  var e =
    ...
    m = {
      _base: e,
      _successTemplate:
        '<div class="pageclip-form__success__message">Merci!</div>',
      ...
      form: function (n, r) {
        ...
        if (
          ...
          !(
            (n = d.jQuery && n instanceof d.jQuery ? n[0] : n) instanceof
            d.HTMLFormElement
          ))
        )
          throw new Error("form() must be passed an HTMLFormElement or String");
        var t = f(n.getAttribute("action")),
          o = { "X-REQMETHOD": "form-v1", "Content-Type": "application/json" },
          e = m.cssBase,
            ...
            s &&
              ...
              m._send(t.key, t.url, o, e, r, function (e, t) {
                s && m._hideSubmitting(n),
                  ...
                  !1 === (!r.onResponse || r.onResponse(e, t)) ||
                    e ||
                    m._showSuccess(n, u),
      ...
      _xhrFetch: function (s, e, t, n, r) {
        ...
        for (o in ((t = (function (e, t) {
          ...
          return e;
        })({ "X-REQTRANSPORT": "xhr", "X-HASFETCH": !!d.fetch }, t)),
        (r = r || a),
  ...
  "undefined" != typeof module && void 0 !== module.exports
    ? ((module.exports = m), (module.exports.normalizeAction = f))
    : ((window.Pageclip = m),
      (function () {
        for (
          var e = document.querySelectorAll("." + m.cssBase), t = 0;
          t < e.length;
          t++
        )
          m.form(e[t]);
